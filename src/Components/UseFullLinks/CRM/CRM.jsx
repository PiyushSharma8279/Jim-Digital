...
function CRM() {
  ...
  useSEO({
    title: "CRM Development Company in Melbourne | Jim Digital",
    description:
      "Grow smarter with a CRM development company in Melbourne. We build custom CRM solutions to streamline processes, boost sales, and improve customer relationships.",
    url: "https://www.jim-digital.com/crm-software-development-company-in-melbourne",
  });
