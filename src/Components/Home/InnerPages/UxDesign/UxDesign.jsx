    ...
    <>
      ...
      <div className="text-center py-16 px-6">
        <h2 className="text-2xl md:text-4xl py-4 font-medium">
          Beyond Creativity: Jim Digital UI UX Design Company in Melbourne
        </h2>
      </div>
        ...
        <div className="flex flex-col md:flex-row w-[90%] py-20 gap-10">
          ...
          <div className="w-full md:w-1/2 px-4 md:px-10 text-left">
            <p className="text-[17px] font-normal text-gray-500">
              Are you tired of websites that look like they were made yesterday? We understand. There are a lot of trends in the digital world, but user-centered design is always in style. Jim Digital is one of the best UI/UX design companies in Melbourne.
               We bridge the gap between cutting-edge design and usability.
            </p>
            ...
            <p className="text-[17px] font-normal text-gray-500">
              We are a YOUNG TEAM that uses the power of experience and the speed of new ideas. We meet deadlines,
               go above and beyond what is expected, and create UI/UX that works..
            </p>
      ...
      <div className="text-white bg-[#0b0f28] text-center py-20 px-4">
        <p className="text-3xl md:text-5xl font-medium">
         Innovative UI UX Design Company in Australia
        </p>
        <p className="mt-4 text-sm md:text-lg max-w-4xl mx-auto text-gray-300">
          We don't just design things to look good; we design them for people. 
          Our biggest challenge is figuring out what users want and how they act.
        </p>
      </div>
