    ...
    <>
      ...
      <div className="text-center px-6">
        ...
        <p className="text-gray-700 max-w-4xl mx-auto">
          ...
          applications, WordPress Development is not an easy service to be
          rendered. Best Website Development Company In Noida.
        </p>
      </div>
        ...
        <div className="flex flex-col md:flex-row w-[90%] py-10 md:py-20 gap-6 md:gap-10">
          ...
          <div className="w-full md:w-1/2 px-4 md:px-10 text-left devText">
            ...
            <p className="text-gray-700">
              ...
              Node.JS, .Net, Python etc. As a Best WordPress Development company
              in Noida we build custom websites in all verticals.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row-reverse w-[90%] py-10 md:py-20 items-center gap-6 md:gap-10">
          ...
          <div className="w-full md:w-1/2 px-4 md:px-10 text-left themesText">
            ...
            <ul className="list-disc list-inside mt-4 space-y-2 text-gray-700">
              <li>
                WordPress Development, a skill involving association with
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 p-6">
        {[
          ...
          <div
            key={i}
            className="shadow-xl rounded-xl h-36 md:h-40 flex flex-col justify-center items-center bg-white hover:scale-105 transition-transform"
          >
            <img
