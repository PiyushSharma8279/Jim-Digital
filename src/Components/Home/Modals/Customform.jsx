        ...
        <div className="min-h-screen flex justify-center items-center bg-gray-100 p-4">
            <div className="bg-white w-full max-w-3xl rounded-lg shadow-lg p-8">
                ...
                <form className="flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-3 mb-4">
                                    {categories.map((cat) => (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-3xl border transition ${selectedCategories.includes(cat)
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`px-6 py-2 rounded-lg ${selectedCategories.length === 0
                        ...
                        <div className="flex flex-wrap gap-3">
                            {features.map((feat) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-3xl border transition ${selectedFeatures.includes(feat)
                    ...
                    <select className="border rounded-md text-gray-600 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option>Do you have a brand style guide,logo and preferred color fonts?</option>
                        <option>Yes</option>
                        <option>No</option>
                    ...
                    <select className="border rounded-md text-gray-600 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option>What type of Application do you need?</option>
                        <option>Web Application</option>
                        <option>Mobile App(ios)</option>
                        <option>Mobile App(Android)</option>
                        <option>Crossplatform mobile app</option>
                        <option>Desktop Software</option>
                        <option>Web Application</option>
                        <option>Browser Extension</option>
                        <option>API(Backend server)</option>
                        <option>Other</option>
                    </select>

                    <select className="border rounded-md text-gray-600 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option>Do you need any Specific Technology</option>
                        <option>Yes</option>
                        <option>No</option>
                    </select>

                    <select className="border rounded-md text-gray-600 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option>Do you have any existing assets?</option>
                        <option>Wireframes / mockups</option>
                        <option>Technical specification document</option>
                        <option>Brand guidelines</option>
                        <option>Crossplatform mobile app</option>
                        <option>API Documentation for Integration</option>
                        <option>Code from a previos attempt</option>
                    </select>
                    <textarea
                        placeholder="What are your main competitors or similar products"
                        className="border rounded-md focus:outline-none px-2 py-2 text-[14px] min-h-[120px] w-full"
                    ></textarea>
