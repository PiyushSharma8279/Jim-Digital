      ...
      <div className="flex flex-wrap justify-center gap-6 px-6 md:px-16 py-8">
        ...
        <div className="relative group">
          <img
            src={wooCommerce}
            alt="WooCommerce"
            className="rounded-xl shadow-lg w-48 md:w-60 lg:w-90 object-cover"
          />
      ...
      <div className="flex flex-wrap justify-center gap-6 px-6 md:px-16 pb-4">
        ...
        <div className="relative group">
          <img
            src={AWS}
            alt="WooCommerce"
            className="rounded-xl shadow-lg w-48 md:w-60 lg:w-65 object-cover"
          />
        ...
        <div className="relative group">
          <img
            src={portal}
            alt="Shopify"
            className="rounded-xl shadow-lg w-48 md:w-68 lg:w-66 object-cover"
          />
        ...
        <div className="relative group">
          <img
            src={website}
            alt="Domain"
            className="rounded-xl shadow-lg w-48 md:w-60 lg:w-66 object-cover"
          />
